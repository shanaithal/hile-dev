...
SMSClient.prototype.triggerAlert = function (buzz) {
    ...
    User.findById(buzz.product_owner_id, function (err, user) {
        if (err) {
            ...
            var smsBodyToAdmin = "User with email: " + buzz.buzzer_mail + " and contact: " + buzz.buzzer_contact + " has buzzed " + buzz.product_id + " with owner contact: " + buzz.userContact;
            twilioClient.sms.messages.create({
                ...
                if (err) {
                    ...
                    console.log('SMS alert with message id ' + message.sid + " sent to " + userContact + " at " + message.dateCreated);
